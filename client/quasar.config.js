...
module.exports = configure(function ( ctx ) {
  return {
    ...
    build: {
      ...
      env: {
        BASE_URL: ctx.dev ? 'http://localhost:3000' : 'http://18.215.168.204',
        CREATOR_NAME: 'Maha Abbadi',
        CREATOR_EMAIL: 'Mabbadi8507@gmail.com',
        LINKEDIN: 'https://www.linkedin.com/in/mahaabbadi/'
      },
